    ...
    <div className="mt-10 py-8 ">
      <Container>
        <div className="flex flex-col items-start">
          ...
          <p>
            The calculations are based on a starting position and some assumptions as to how the future will look. It
            will currently work only for Australian or Scottish residents. I offer no guarantee that the calculations
            are correct.{" "}
          </p>
