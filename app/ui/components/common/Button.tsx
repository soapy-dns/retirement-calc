  ...
  const getButtonClassName = () => {
    switch (buttonType) {
      ...
      case ButtonType.secondary:
        return "display-block w-full my-4 rounded-full border-2  border-primary  py-1 px-4 text-primary-foreground  disabled:opacity-40 focus:outline-none focus:ring-1 focus:ring-offset-2 focus:ring-opacity-75 focus:ring-primary flex flex-row justify-center items-center"
      default:
