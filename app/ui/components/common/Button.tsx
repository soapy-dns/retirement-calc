  ...
  if (buttonType === ButtonType.primary) {
    return (
      <button
        ...
        disabled={disabled}
        className="my-4 mx-4 rounded-full focus:outline-none focus:ring-1 focus:ring-offset-2 focus:ring-opacity-75 focus:ring-primary bg-primary py-1 px-4 shadow-lg text-white hover:bg-primary-darker disabled:opacity-40"
      >
        {children}
      </button>
    )
