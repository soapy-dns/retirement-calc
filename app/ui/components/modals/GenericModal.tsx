...
export const GenericModal = (props: IGenericModalProps) => {
  ...
  return (
    <div
      ...
      className={`${modalHiddenClass} h-modal fixed right-0 left-4 top-8 z-50 items-center justify-center overflow-y-auto overflow-x-hidden bg-muted/75 md:inset-0 md:h-full`}
    >
