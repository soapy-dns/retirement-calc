...
- Cash
- Properties
- Pension pot - Defined contribution / money purchase
- Shares
...
The order this is done will be controlled by the drawdown order specified in the asset configuration, _and_ and mandatory percentages that need to be taken.
